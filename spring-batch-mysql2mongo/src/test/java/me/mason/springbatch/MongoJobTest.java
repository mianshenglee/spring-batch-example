...
import me.mason.springbatch.example.mysql2mongo.config.MongoBatchConfig;
...
@SpringBootTest(classes = {MainBootApplication.class, MongoBatchConfig.class})
@Slf4j
public class MongoJobTest {
